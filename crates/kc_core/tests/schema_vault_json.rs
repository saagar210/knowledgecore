...
fn vault_json_v2_schema() -> serde_json::Value {
    serde_json::json!({
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "$id": "kc://schemas/vault-json/v2",
      "type": "object",
      "required": [
        "schema_version",
        "vault_id",
...
#[test]
fn schema_vault_json_accepts_generated_v2_payload() {
    ...
    let schema = JSONSchema::compile(&vault_json_v2_schema()).expect("compile vault schema");
    assert!(schema.is_valid(&value));
}

#[test]
fn schema_vault_json_rejects_missing_encryption_block() {
